...
<%
 /**
  * @Class Name : DebtRegister.jsp
  * @Description : Debt Register 화면
...
<c:set var="registerFlag" value="${empty debtVO.id ? '등록' : '수정'}"/>			
...
<!-- validator:javascript formName="debtVO" staticJavascript="false" xhtml="true" cdata="false"/ -->

<script type="text/javaScript" language="javascript" defer="defer">
<!--
/* 글 목록 화면 function */
function fn_egov_selectList() {
   	document.getElementById("detailForm").action = "<c:url value='/debt/DebtList.do'/>";
   	document.getElementById("detailForm").submit();		
}

/* 글 삭제 function */
function fn_egov_delete() {
   	document.getElementById("detailForm").action = "<c:url value='/debt/deleteDebt.do'/>";
   	document.getElementById("detailForm").submit();		
}
...
function fn_egov_save() {	
	...
	/* TODO Validation기능 보완 */
  	...
  	frm.action = "<c:url value="${registerFlag == '등록' ? '/debt/addDebt.do' : '/debt/updateDebt.do'}"/>";
    frm.submit();
...
<form:form modelAttribute="debtVO" name="detailForm" id="detailForm" >
<div id="content_pop">
	<!-- 타이틀 -->
	<div id="title">
		<ul>
