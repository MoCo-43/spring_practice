...
<%
 /**
  * @Class Name : DebtList.jsp
  * @Description : Debt List 화면
...
function fn_egov_select(id) {
    document.getElementById("listForm").id.value = id;
   	document.getElementById("listForm").action = "<c:url value='/debt/updateDebtView.do'/>";
   	document.getElementById("listForm").submit();
}

/* 글 등록 화면 function */
function fn_egov_addView() {
   	document.getElementById("listForm").action = "<c:url value='/debt/addDebtView.do'/>";
   	document.getElementById("listForm").submit();		
}
...
function fn_egov_link_page(pageNo){
	...
	document.getElementById("listForm").action = "<c:url value='/debt/DebtList.do'/>";
   	document.getElementById("listForm").submit();
}
